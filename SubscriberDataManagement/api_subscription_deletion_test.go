...
func TestUnsubscribe(t *testing.T) {
	...
	go func() { // fake udr server
		...
		router.DELETE("/nudr-dr/v1/subscription-data/:ueId/context-data/sdm-subscriptions/:subsId", func(c *gin.Context) {
			...
			fmt.Println("==========Unsubscribe - unsubscribe from notifications==========")
	...
	supi := "SDM1234"
	subscriptionId := "SubscriptionId_test"
	resp, err := clientAPI.SubscriptionDeletionApi.Unsubscribe(context.TODO(), supi, subscriptionId)
	if err != nil {
